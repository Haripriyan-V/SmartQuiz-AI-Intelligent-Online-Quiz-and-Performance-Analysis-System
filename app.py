...
app = Flask(__name__)
app.secret_key = 'hari'  # Set this to a random value for security


# MySQL Database Configuration
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Hari*7871795057.@localhost/quizManagementSystem'  # Update password and DB name
